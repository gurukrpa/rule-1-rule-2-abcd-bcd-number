-- 🚀 FIXED EMERGENCY DATABASE RESTORATION SCRIPT  
-- This script fixes the column naming issues and restores all essential tables
...
DROP TABLE IF EXISTS number_box_clicks CASCADE;

-- ========================================
-- CORE APPLICATION TABLES (CORRECTED)
-- ========================================
...
-- 2. Excel data table (for file uploads and analysis) - FIXED COLUMN NAMES
CREATE TABLE IF NOT EXISTS excel_data (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
    user_id VARCHAR(255) NOT NULL,
    date_key VARCHAR(255) NOT NULL,  -- This is the correct column name
...
-- 3. Hour entries table (for HR data management) - FIXED COLUMN NAMES  
...
-- 4. Number box clicks table (for Rule1Page_Enhanced interactions) - FIXED COLUMN NAMES
CREATE TABLE IF NOT EXISTS number_box_clicks (
    id TEXT PRIMARY KEY,
    user_id VARCHAR(255) NOT NULL,
    set_name VARCHAR(255) NOT NULL,
    date_key DATE NOT NULL,  -- This is the correct column name
...
SELECT 
    ...
    'All essential tables recreated with correct column names' as message,
    'date_key columns are now properly configured' as fix_applied,
