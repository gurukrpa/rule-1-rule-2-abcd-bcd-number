      ...
      <div className="max-w-md w-full space-y-8">
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            {/* Development Auto-Login Notice (localhost only) */}
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <p className="text-sm text-blue-800">
                      <strong>🔧 Development Mode:</strong> Auto-login is enabled for localhost. 
                      If you need to test with different credentials, you can still use this form.
                    </p>
                  </div>
                </div>
              </div>
